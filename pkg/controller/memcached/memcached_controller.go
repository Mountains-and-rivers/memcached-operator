...
import (
	...
	cachev1alpha1 "github.com/tanjunchen/memcached-operator/pkg/apis/cache/v1alpha1"
...
func (r *ReconcileMemcached) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	fmt.Println(time.Now().String(), "......Kubernetes Operator Framework Reconcile......")
	...
	if !reflect.DeepEqual(podNames, memcached.Status.Nodes) {
		fmt.Println(time.Now().String(), "......Kubernetes Operator Framework Update Pod Name ......")
